...
class StudentReportCardTests(TestCase):
    ...
    def setUp(self) -> None:
        self.student_card = StudentReportCard("Bobi", 12)

    def test_init_student_report_student_card(self):
        self.assertEqual("Bobi", self.student_card.student_name)
    ...
    def test_student_name_cannot_be_empty_string_raises(self):
        with self.assertRaises(ValueError) as ex:
            new_record = StudentReportCard("", 5)
    ...
    def test_school_year_not_in_range_1_to_12_raises(self):
        with self.assertRaises(ValueError) as ex:
            new_record = StudentReportCard("student", 0)
